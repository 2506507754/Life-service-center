...
{
    this.regInfo    = "欢迎使用日期控件;关闭的快捷键：[Esc]";
    ...
    this.darkColor  = "#5353FF";    //控件的暗色
    this.lightColor = "#FFFFFF";    //控件的亮色
    this.btnBgColor = "#ADBFFE";    //控件的按钮背景色
    this.wordColor  = "#000040";    //控件的文字颜色
    this.wordDark   = "#DCDCDC";    //控件的暗文字颜色
    this.dayBgColor = "#DBD9FF";    //日期数字背景色
    this.todayColor = "#8494FF";    //今天在日历上的标示背景色
    this.DarkBorder = "#A8B6BF";    //日期显示的立体表达色
...
function calendar() //主调函数
{
    ...
    try{
        if (WebCalendar.objExport.value.trim() != ""){
            WebCalendar.dateStyle = WebCalendar.objExport.value.replace('00:00:00.0','').trim().match(WebCalendar.dateReg);
