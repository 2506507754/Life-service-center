...
function richContext(obj)
{
  ...
  oPopup.document.body.onmouseout =function func_onmouseouto() {top.menuTimer=setTimeout("top.oPopup.hide();",4000);} ;
  oPopup.document.body.onmouseover =function func_onmouseouover() {clearTimeout(top.menuTimer);}; 
...
function ActEvent(oPopupBody) {
  var xchild = oPopupBody.childNodes(0);
  for(var i = 0; i < xchild.childNodes.length;i++) {
	 xchild.childNodes[i].style.cssText ="	font-size: 12px;line-height: 22px;color: #000000;text-decoration: none;" ;
