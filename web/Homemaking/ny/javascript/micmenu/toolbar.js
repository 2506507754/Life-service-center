...
if (ToolBar_Supported)
{
	...
	HTMLStr = 
		...
		"<DIV ID='idMSMenuCurve' STYLE='position:absolute;top:0;left:250;height:20;width:18;overflow:hidden;vertical-align:top;'><IMG SRC='micmenu/curve.gif' BORDER=0></DIV>" +
...
function setBanner(BanGif, BanUrl, BanAltStr, BanBegTag, BanEndTag)
{
	...
	SrcStr = "";
	if (BanUrl != "")
		SrcStr += "<A Target='_top' HREF='../../../www.gz-tb.net/3838/js/menu/micmenu/%22%20%2B%20formatURL(BanUrl,%20BanGif)%20%2B%20%22'>";
	SrcStr += "<IMG SRC='../../../www.gz-tb.net/3838/js/menu/micmenu/%22%20%2B%20BanGif%20%2B%20%22' ALT='" + BanAltStr + "' BORDER=0>";
	if (BanUrl != "")
		SrcStr += "</A>";
